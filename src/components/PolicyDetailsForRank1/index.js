...
export default class PolicyDetailsForRank1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      itineraryId: "",
    ...
    return (
      <>
        ...
        <Container className="selectPoliciesContainer">
          <h1>Select policies from the list below for users in Rank 1 Category</h1>
          <Card className="policyCard">
                  <Card.Header as="h5">
                    <Row>
                      <Col className="fs-20 fw-800">
                        Policy Name : Equity Linked Saving Scheme
                      </Col>
                      <Col xs="4" md="2" lg="2">
                      ...
                      <Col>
                        <Card.Text className="fs-18">
                          ...
                          <div>
                            ...
                            {"   "}
                            <span className="fs-15">3 years</span>
                          </div>
                        </Card.Text>
                      </Col>
                      <Col lg={4}>
